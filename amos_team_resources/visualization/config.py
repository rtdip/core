...
VISUALIZATION_BACKEND = 'matplotlib'  # Options: 'matplotlib' or 'plotly'
...
METRIC_ORDER = ['mae', 'rmse', 'mse', 'mape', 'smape', 'r2']

# SUBPLOT GRID LAYOUTS

def get_grid_layout(n_plots):
    """
...
def get_figsize_for_grid(n_plots):
    """
