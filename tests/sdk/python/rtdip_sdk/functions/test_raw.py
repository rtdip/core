...
MOCKED_QUERY='SELECT from_utc_timestamp(EventTime, "+0000") as EventTime, TagName, Status, Value FROM mocked-buiness-unit.sensors.mocked-asset_mocked-data-security-level_events_mocked-data-type WHERE EventDate BETWEEN to_date(to_timestamp(\'2011-01-01T00:00:00+0000\')) AND to_date(to_timestamp(\'2011-01-02T23:59:59+0000\')) AND EventTime BETWEEN to_timestamp(\'2011-01-01T00:00:00+0000\') AND to_timestamp(\'2011-01-02T23:59:59+0000\') AND TagName in (\'MOCKED-TAGNAME\') ORDER BY EventTime'
