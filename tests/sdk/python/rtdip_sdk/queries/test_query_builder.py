...
def test_query_builder_resample(mocker: MockerFixture):
    mocker.patch("src.sdk.python.rtdip_sdk.queries.query_builder.resample.get", return_value={"test": "data"})
...
def test_query_builder_interpolate(mocker: MockerFixture):
    mocker.patch("src.sdk.python.rtdip_sdk.queries.query_builder.interpolate.get", return_value={"test": "data"})
...
def test_query_builder_interpolation_at_time(mocker: MockerFixture):
    mocker.patch("src.sdk.python.rtdip_sdk.queries.query_builder.interpolation_at_time.get", return_value={"test": "data"})
...
def test_query_builder_twa(mocker: MockerFixture):
    mocker.patch("src.sdk.python.rtdip_sdk.queries.query_builder.time_weighted_average.get", return_value={"test": "data"})
...
def test_query_builder_metadata(mocker: MockerFixture):
    mocker.patch("src.sdk.python.rtdip_sdk.queries.query_builder.metadata.get", return_value={"test": "data"})
