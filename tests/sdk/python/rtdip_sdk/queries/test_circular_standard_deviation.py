...
from src.sdk.python.rtdip_sdk.queries.time_series.circular_standard_deviation import get as circular_standard_deviation_get
...
def test_circular_standard_deviation(mocker: MockerFixture):
    ...
    actual = circular_standard_deviation_get(mocked_connection, MOCKED_PARAMETER_DICT)
...
def test_circular_standard_deviation_fails(mocker: MockerFixture):
    ...
    with pytest.raises(Exception):
        circular_standard_deviation_get(mocked_connection, MOCKED_PARAMETER_DICT)
