...
def test_latest(mocker: MockerFixture):
    ...
    actual = latest_raw(mocked_connection, MOCKED_PARAMETER_DICT)
...
def test_latest_offset_limit(mocker: MockerFixture):
    ...
    actual = latest_raw(mocked_connection, MOCKED_PARAMETER_OFFSET_LIMIT_DICT)
...
def test_no_tag_latest(mocker: MockerFixture):
    ...
    actual = latest_raw(mocked_connection, MOCKED_PARAMETER_NO_TAGS_DICT)
...
def test_latest_fails(mocker: MockerFixture):
    ...
    with pytest.raises(Exception):
        latest_raw(mocked_connection, MOCKED_PARAMETER_DICT)
