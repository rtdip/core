...
import numpy as np
import xarray as xr
from src.sdk.python.rtdip_sdk.pipelines.transformers.spark.weather.ECMWF.nc_extractbase_to_weather_data_model import ECMWFExtractBaseToWeatherDataModel
...
def test_convert_ws_tag_names():
    extract = ECMWFExtractBaseToWeatherDataModel(load_path, date_start, date_end, run_interval, run_frequency, lat, lon)
