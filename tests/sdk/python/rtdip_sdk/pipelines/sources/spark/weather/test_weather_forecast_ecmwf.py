...
from src.sdk.python.rtdip_sdk.pipelines.sources.spark.the_weather_company.ECMWF.weather_forecast_ecmwf import (
    WeatherForecastECMWFSource,
)
...
def test_read_batch(spark_session: SparkSession):
    weather_source = WeatherForecastECMWFSource(
        spark_session,
        date_start=date_start,
        date_end=date_end,
        save_path=save_path,
