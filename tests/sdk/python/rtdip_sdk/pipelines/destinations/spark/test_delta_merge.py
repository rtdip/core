...
def test_spark_delta_merge_update_by_source_write_batch(spark_session: SparkSession):
    ...
    delta_destination = SparkDeltaDestination(create_table_df, {}, mode="overwrite", table_name= "test_spark_delta_merge_update_by_source_write_batch")
    delta_destination.write_batch()
    try:
...
def test_spark_delta_merge_delete_by_source_write_batch(spark_session: SparkSession):
    ...
    delta_destination = SparkDeltaDestination(create_table_df, {}, mode="overwrite", table_name= "test_spark_delta_merge_delete_by_source_write_batch")
    delta_destination.write_batch()
    try:
        _package_version_meets_minimum("delta_spark", "2.3.0")
