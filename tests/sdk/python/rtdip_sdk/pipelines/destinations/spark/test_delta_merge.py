...
def test_spark_delta_merge_update_write_batch(spark_session: SparkSession):
    ...
    delta_destination_merge = SparkDeltaMergeDestination(spark_session, expected_df, "test_spark_delta_merge_update_write_batch", {}, "source.id = target.id", when_matched_update_list=[DeltaMergeConditionValues(values={"value": "2"})])
...
def test_spark_delta_merge_update_all_write_batch(spark_session: SparkSession):
    ...
    delta_destination.write_batch()
    delta_destination_merge = SparkDeltaMergeDestination(spark_session, expected_df, "test_spark_delta_merge_update_all_write_batch", {}, "source.id = target.id", when_matched_update_list=[DeltaMergeConditionValues(values="*")])
    delta_destination_merge.write_batch()
...
def test_spark_delta_merge_insert_write_batch(spark_session: SparkSession):
    ...
    delta_destination.write_batch()
    delta_destination_merge = SparkDeltaMergeDestination(spark_session, merge_table_df, "test_spark_delta_merge_insert_write_batch", {}, "source.id = target.id", when_not_matched_insert_list=[DeltaMergeConditionValues(values={"id": "source.id", "value": "source.value"})])
    delta_destination_merge.write_batch()
...
def test_spark_delta_merge_insert_all_write_batch(spark_session: SparkSession):
    ...
    delta_destination.write_batch()
    delta_destination_merge = SparkDeltaMergeDestination(spark_session, merge_table_df, "test_spark_delta_merge_insert_all_write_batch", {}, "source.id = target.id", when_not_matched_insert_list=[DeltaMergeConditionValues(values="*")])
    delta_destination_merge.write_batch()
...
def test_spark_delta_merge_delete_write_batch(spark_session: SparkSession):
    ...
    delta_destination.write_batch()
    delta_destination_merge = SparkDeltaMergeDestination(spark_session, merge_table_df, "test_spark_delta_merge_delete_write_batch", {}, "source.id = target.id", when_matched_delete_list=[DeltaMergeCondition()])
    delta_destination_merge.write_batch()
...
def test_spark_delta_merge_update_write_stream_micro_batch(spark_session: SparkSession):
    ...
    delta_destination.write_batch()
    delta_destination_merge = SparkDeltaMergeDestination(spark_session, expected_df, "test_spark_delta_merge_update_write_stream_micro_batch", {}, "source.id = target.id", when_matched_update_list=[DeltaMergeConditionValues(values={"value": "2"})])
