...
def test_spark_rest_api_write_setup():
    delta_merge_destination = SparkRestAPIDestination(None, {}, test_url, {}, 1, parallelism=1)
...
def test_spark_rest_api_write_stream(spark_session: SparkSession, mocker: MockerFixture):
    ...
    eventhub_destination = SparkRestAPIDestination(expected_df, {}, test_url, {}, 1, parallelism=1)
