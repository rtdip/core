...
from src.sdk.python.rtdip_sdk.pipelines.utilities.spark.delta_table_optimize import (
...
def test_spark_delta_table_optimize(spark_session: SparkSession):
    ...
    delta_table_optimize = DeltaTableOptimizeUtility(
        spark=spark_session,
        table_name="test_table_delta_optimize",
    ...
    result = delta_table_optimize.execute()
    assert result
