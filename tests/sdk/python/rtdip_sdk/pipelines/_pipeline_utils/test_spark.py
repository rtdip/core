...
def test_get_spark_session(spark_session: SparkSession):
    ...
    # assert spark_session.conf.get("configuration_test1") == "configuration_test_value1"
    # assert spark_session.conf.get("configuration_test2") == "configuration_test_value2"
