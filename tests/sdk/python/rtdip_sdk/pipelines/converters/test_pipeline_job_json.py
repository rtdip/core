...
from src.sdk.python.rtdip_sdk.pipelines.converters.pipeline_job_json import PipelineJobFromJson, PipelineJobToJson
...
def test_pipeline_job_convert_to_json():
    ...
    pipeline_job_json_actual = PipelineJobToJson(pipeline_job).convert()
