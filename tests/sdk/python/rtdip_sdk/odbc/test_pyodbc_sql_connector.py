...
from src.sdk.python.rtdip_sdk.odbc.pyodbc_sql_connector import PYODBCSQLConnection
from src.sdk.python.rtdip_sdk.odbc.pyodbc_sql_connector import PYODBCSQLCursor
import pandas as pd
...
def test_connection_close(mocker: MockerFixture):
    ...
    pmocked_connection = PYODBCSQLConnection(DRIVER_PATH, SERVER_HOSTNAME, ACCESS_TOKEN, HTTP_PATH)
...
def test_connection_close_fails(mocker: MockerFixture):
    ...
    mocked_connection =  PYODBCSQLConnection(DRIVER_PATH, SERVER_HOSTNAME, ACCESS_TOKEN, HTTP_PATH)
