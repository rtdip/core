...
def test_LAMBDA_TRANSFORM_TYPE_CHECK():
    ...
    try:
        ...
        logging.debug('Source Record     : [{}]'.format(test_input_record_sample_date_str))
...
def test_LAMBDA_TRANSFORM_METHOD_REPLACE():
    ...
    try:
        ...
        logging.debug('Source Record     : [{}][{}]'.format(test_input_record_str, source_num_of_Bs_int))
        logging.debug('Transformed Record: [{}][{}]'.format(result_str, result_num_of_Bs_int))
