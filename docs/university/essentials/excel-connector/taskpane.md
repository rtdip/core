...
4. Search for a different tag with the tag explorer <img src="/university/essentials/excel-connector/assets/tagsearch-icon.png" width="30" alt="tagsearch" /> and add one to your query.
5. Explore the dashboard <img src="/university/essentials/excel-connector/assets/dashboard-icon.png" width="30" alt="dashboard" /> and `edit`, `delete` or `refresh` one of your queries.
