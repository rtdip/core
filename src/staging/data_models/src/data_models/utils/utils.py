...
def get_intervals(series_type_st: SeriesType.SeriesType, timestamp_date: date):
    ...
    i = 0
    logger.debug(now_local_datetime_plus.tzinfo.tzname(now_local_datetime_plus))
    ...
    while now_local_datetime_plus.date() < timestamp_date:
        ...
        logger.debug(now_local_datetime_plus)
        logger.debug(now_local_datetime_plus.date())
        logger.debug(i)
        i = i + 1
