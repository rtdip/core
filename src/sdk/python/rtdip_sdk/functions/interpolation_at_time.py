...
def get(connection: object, parameters_dict: dict) -> pd.DataFrame:
    ...
    Attributes:
        ...
        timestamps (list): List of timestamp or timestamps in the format YYY-MM-DDTHH:MM:SS or YYY-MM-DDTHH:MM:SS+zzzz where %z is the timezone. (Example +00:00 is the UTC timezone)
