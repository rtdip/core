...
class TURBODBCSQLConnection(ConnectionInterface):
    """
    **DEPRECATED:** Turbodbc is no longer inherently supported in RTDIP (as of v0.14.3). This connector is maintained for backward compatibility only.

    If you require turbodbc connectivity, you have two options:

    1. Use an older RTDIP version (prior to v0.14.3) that includes turbodbc support
