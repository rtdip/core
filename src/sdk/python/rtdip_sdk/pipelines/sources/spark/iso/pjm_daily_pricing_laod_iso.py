...
class PJMDailyPricingLoadISOSource(BaseISOSource):
    """
    The PJM Daily Pricing Load ISO Source is used to read Real-Time and Day-Ahead hourly loads data from PJM API. It supports both Real-Time Hourly LMPs and Day-Ahead Hourly LMPs data. Real-Time will return privous 1 day, Day-Ahead will return T + 1 days data.
