...
from  src.sdk.python.rtdip_sdk.pipelines.logging.spark.log_file.file_log_handler import FileLogHandler
...
class RuntimeLogCollector(LoggingBaseInterface):
    ...
    @classmethod
    def _attach_file_handler_to_loggers(cls, filename: str, path: str = '.',  mode: str = 'a') -> None:
